...
public class Update_Customer extends JFrame implements ActionListener{
    ...
    Update_Customer()
    {
        ...
        setLocation(10,10);
        setResizable(false);
        ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("com/Gym_Management_System/icons/18.png"));
        //com/Gym_Management_System/icons/9.png
        ...
        try
        {
            ...
            String q3="select recipt_no from add_customer";
            ResultSet rest3=obj3.stm.executeQuery(q3);
            while(rest3.next())
            {
                ch6.add(rest3.getString("recipt_no"));
            }
        }
        catch(Exception ee)
        {
        ...
        ch6.addMouseListener(new MouseAdapter()
        {
            ...
            public void mouseClicked(MouseEvent arg0)
            {
                try
                {
                    ...
                    String querry="select * from add_customer where recipt_no='"+recipt_id+"'";
    ...
    public void actionPerformed(ActionEvent e)
    {
        try
        {
            ...
            if(e.getSource()==bt1)
            {
                ...
                String q="update add_customer set name='"+name+"',fname='"+fname+"',email='"+email+"',address='"+address+"',contactNo='"+cont+"',payments_plan='"+minag+"',gender='"+gender+"',height='"+height+"',weight='"+weight+"',remarks='"+remarks+"',trainer_name='"+tname+"',catogery='"+tcat+"' where recipt_no='"+tid+"' ";
