...
public class Customer_Fees extends JFrame implements ActionListener{
    ...
    Customer_Fees()
    {
        ...
        ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("com/Gym_Management_System/icons/17.png"));
            ...
            public void mouseClicked(MouseEvent arg)
            {
                ...
                try
                {
                    ...
                    while(rest1.next())
                    {
                        ...
                        tf2.setText(rest1.getString("catogery"));
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        try
        {
            ...
            {
                Connection_Class obj2=new Connection_Class();
                String q2="insert into pay_customer values('"+id+"','"+name+"','"+category+"','"+fess+"','"+month+"','"+trainer_name+"')";
