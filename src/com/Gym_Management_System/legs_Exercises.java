...
public class legs_Exercises extends JFrame
{
    ...
    legs_Exercises()
    {
        ...
        ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("com/Gym_Management_System/icons/l1.jpg"));
        Image imag=img.getImage().getScaledInstance(300,350,Image.SCALE_DEFAULT);
        l1=new JLabel(new ImageIcon(imag));

        ImageIcon img1=new ImageIcon(ClassLoader.getSystemResource("com/Gym_Management_System/icons/l2.jpg"));
        Image imag1=img1.getImage().getScaledInstance(300,350,Image.SCALE_DEFAULT);
        l2=new JLabel(new ImageIcon(imag1));

        ImageIcon img2=new ImageIcon(ClassLoader.getSystemResource("com/Gym_Management_System/icons/l3.jpg"));
        Image imag2=img2.getImage().getScaledInstance(300,350,Image.SCALE_DEFAULT);
        l3=new JLabel(new ImageIcon(imag2));

        ImageIcon img3=new ImageIcon(ClassLoader.getSystemResource("com/Gym_Management_System/icons/l4.jpg"));
        Image imag3=img3.getImage().getScaledInstance(300,350,Image.SCALE_DEFAULT);
        l4=new JLabel(new ImageIcon(imag3));

        ImageIcon img4=new ImageIcon(ClassLoader.getSystemResource("com/Gym_Management_System/icons/l5.jpg"));
        Image imag4=img4.getImage().getScaledInstance(300,350,Image.SCALE_DEFAULT);
        l5=new JLabel(new ImageIcon(imag4));

        ImageIcon img5=new ImageIcon(ClassLoader.getSystemResource("com/Gym_Management_System/icons/l6.jpg"));
        Image imag5=img5.getImage().getScaledInstance(300,350,Image.SCALE_DEFAULT);
        l6=new JLabel(new ImageIcon(imag5));

        ImageIcon img6=new ImageIcon(ClassLoader.getSystemResource("com/Gym_Management_System/icons/l7.jpg"));
        Image imag6=img6.getImage().getScaledInstance(300,350,Image.SCALE_DEFAULT);
        l7=new JLabel(new ImageIcon(imag6));

        ImageIcon img7=new ImageIcon(ClassLoader.getSystemResource("com/Gym_Management_System/icons/l8.jpg"));
