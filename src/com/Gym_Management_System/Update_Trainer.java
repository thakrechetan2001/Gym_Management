...
public class Update_Trainer extends JFrame implements ActionListener{
    ...
    Update_Trainer()
    {
        ...
        setLocation(10,10);
        setResizable(false);
        ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("com/Gym_Management_System/icons/9.png"));
        ...
        try
        {
            Connection_Class obj0=new Connection_Class();
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        try
        {
            if(e.getSource()==bt1)
            {
                ...
                String q="update add_trainer set name='"+name+"',fname='"+fname+"',email='"+email+"',address='"+address+"',contactno='"+cont+"',emerggincyno='"+eno+"',catogery='"+tcat+"',min_aggrement='"+minag+"',gender='"+gender+"',height='"+height+"',weight='"+weight+"',remarks='"+remarks+"' where tid='"+tid+"' ";
